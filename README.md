...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff5ab4f8b3b1600168a03ec
...
To start editing your site, you can use the Sanity interface at https://oceanic-sycamore-5ab4f.sanity.studio/.
...
Generated at `2021-01-06T12:21:57.873Z` by Stackbit version `0.3.42`.